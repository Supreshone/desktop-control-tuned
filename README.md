...
This edition is a **Python-first integration** — taking the Python implementation as the core module and aligning it with the OpenClaw workspace standard. The goal is to provide a clean, importable Python package that any AI agent can use for Windows desktop automation, with better structure and documentation than either original.
